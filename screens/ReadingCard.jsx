...
const ReadingCard = (props) => {
  ...
  // Setup Realtime Listening for the specific day's readings
  const { day } = props
...
//onShanpshot = listhening to the data changes  
      ...
      setReadings(readingData) //<--update useState that displays my readings
      ...
      return () => {
        ...
        unsubscribe(); //<--stopes listhening for data changes
      };
    }, [])
  );
